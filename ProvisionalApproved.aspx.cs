...
public partial class ProvisionalApproved : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("update protb  set Status='" + RadioButtonList1.Text + "', Date='" + System.DateTime.Now.ToShortDateString() + "' where id='" + id + "' ", con);
        cmd.ExecuteNonQuery();
        con.Close();
        ...
        //if (dr.Read())
        //{
        //    sendmessage(dr["Mobileno"].ToString(), " Your Provisional Certificate Has " + RadioButtonList1.Text);
        //}
        //con.Close();
    ...
    private void bind()
    {
        cmd = new SqlCommand("select * from protb where Status='waiting' ", con);
        ...
        cmd = new SqlCommand("select * from protb where Status='Approved' ", con);
        ...
        cmd = new SqlCommand("select * from protb  where Status='Reject' ", con);
