...
public partial class Provisional : System.Web.UI.Page
{
    ...
    {
        cmd = new SqlCommand("insert into protb values('" + Session["uname"].ToString() + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','','Waiting')", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
